...
<div class="min-vh-100 d-flex align-items-center justify-content-center bg-light">
    <div class="container mt-5">
        <div class="row justify-content-center rounded-4 shadow-lg overflow-hidden bg-white">
            <div class="col-lg-5 col-md-8 p-5">
                <div class="text-center mb-3">
                    <h1 class="fw-bold text-primary fs-3 mb-1">{{ config('app.name', 'E-Rent') }}</h1>
                    <p class="text-muted mb-0">Find your perfect rental home</p>
                </div>
                <h5 class="text-center fw-semibold mb-4 text-dark">Welcome back</h5>
                <div class="mb-3">
                    <a href="" 
                       class="btn btn-secondary w-100 d-flex align-items-center justify-content-center gap-2 rounded-pill">
                ...
                <p class="text-center mt-4 mb-0 text-muted small">
                    ...
                    <a href="" class="text-primary fw-semibold">Create an account</a>
                </p>
            </div>
