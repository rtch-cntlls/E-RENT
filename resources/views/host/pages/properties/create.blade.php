...
<div class="container create-property">
    <div class="card shadow-sm border-0 p-4">
        <form action="{{ route('host.properties.store') }}" method="POST">
            @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-2">
                        ...
                        <textarea name="description" id="description" class="form-control form-control-lg rounded-3" rows="4" placeholder="Write a brief description about your property">{{ old('description') }}</textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="mb-2">
               ...
               <div class="col-md-6">
                    <div class="mb-2">
                        ...
                        <div class="input-group rounded-3">
                            ...
                            <input type="text" name="address" id="address" class="form-control rounded-end" value="{{ old('address') }}" placeholder="Property Address" required>
                        </div>
                    </div>
               </div>
                <div class="col-md-6">
                    <div class="mb-2">
                        ...
                        <div class="input-group rounded-3">
                            ...
                            <input type="number" step="0.01" name="price" id="price" class="form-control rounded-end" value="{{ old('price') }}" placeholder="0.00" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-2">
                        ...
                        <div class="input-group rounded-3">
                            ...
                            <input type="number" name="fixed_days" id="fixed_days" class="form-control rounded-end" value="{{ old('fixed_days') }}" placeholder="Enter minimum/fixed days" min="1">
                        </div>
                    </div>
                </div>                
                <div class="mb-2">
                    <label class="form-label fw-semibold small">Amenities</label>
                    <div id="amenities-container" class="d-flex flex-wrap gap-2">
                    </div>
                    <input type="hidden" name="amenities" id="amenities-input" value="{{ old('amenities') ? implode(',', old('amenities')) : '' }}">
                </div>
            </div>
        </form>
    </div>
